...
class MultiView(object):
	def __init__(self, obs_shape, action_shape, args):
		...
		shared_cnn_1 = m.SharedCNN(obs_shape, args.num_shared_layers, args.num_filters).cuda() # Third Person Image
		shared_cnn_2 = m.SharedCNN(obs_shape, args.num_shared_layers, args.num_filters).cuda() # First Person Image
